# DailyQuest 🏋️‍♂️ - Gamify Your Life
...
### Charakter-Fortschritt & Personalisierung
...
- **🌳 Fokus-Modul:** Ein spezieller Bereich, um deine Konzentration zu trainieren.
  ...
  - **Kategorien-System:** Organisiere deine Fokus-Sessions nach Themen (z.B. Sprachen lernen, Coding, Lesen).
...
### Dungeons & Kampfsystem
- **💉 Zufällige Dungeons:** Mit 5% Wahrscheinlichkeit erscheint beim App-Start ein Dungeon, den du herausfordern kannst.
- **⚔️ Kampfsystem:** Besiege Monster durch das Absolvieren von körperlichen Übungen:
  - **Liegestütze:** 10 Schaden pro Wiederholung
  - **Squats:** 6 Schaden pro Wiederholung
  - **Sit-Ups:** 5 Schaden pro Wiederholung
- **👾 Monster-Typen:** Kämpfe gegen Schattenwölfe, Höhlenbären und Morast-Zombies.
- **📈 Skalierung:** Jeder besiegte Dungeon erhöht das Monster-Level - die Herausforderung wächst mit dir!
- **💎 Belohnungen:** Siege bringen wertvolle Mana-Steine und Erfahrungspunkte.
- **❤️ Persistente HP:** Deine Lebenspunkte bleiben zwischen Kämpfen erhalten - plane deine Kämpfe strategisch!
- **🎭 Animationen:** Genieße flüssige Kampf-Animationen mit visuellen Effekten bei Treffern und Schaden.
...
2.  **Die tägliche Routine (🏋️‍♀️ Übungen):**
    ...
    - **🏠 Home-Gym Tipp:** Alle Übungen funktionieren mit Hanteln, Langhantel oder Körpergewicht - perfekt für das Training zu Hause!
...
6.  **Konzentration trainieren (🌳 Fokus):**
    ...
    - Starte eine Sitzung und lege alle Ablenkungen beiseide.
    - Schließe die Sitzung erfolgreich ab, um Belohnungen zu erhalten und deine Statistiken zu verbessern.

7.  **Dungeons besiegen (💉 Dungeons):**
    - Mit 5% Wahrscheinlichkeit erscheint beim App-Start ein Dungeon-Chip am unteren Bildschirmrand.
    - Klicke auf "Los!" um den Dungeon zu betreten und einem zufälligen Monster gegenüberzutreten.
    - Besiege das Monster durch das Absolvieren von Übungen:
      - Gib die Anzahl der Wiederholungen ein und klicke auf "OK".
      - Jede Übung verursacht unterschiedlich viel Schaden am Monster.
      - Das Monster schlägt automatisch zurück - achte auf deine HP!
    - **Sieg:** Erhalte Mana und wertvolle Mana-Steine für dein Inventar.
    - **Niederlage:** Keine Belohnungen, aber der Dungeon bleibt aktiv für einen weiteren Versuch.
    - **Strategie:** Nutze bessere Ausrüstung für höheren Angriff und Schutz!

8.  **Herausforderungen annehmen (📜 Extra-Quest):**
...
-   **Icons & Design:**
    -   `Material Symbols Rounded`: Alle Icons in der App verwenden Googles Material Symbols (Rounded Variante) statt Emojis für ein einheitliches, professionelles Design. Die Icons werden als Icon-Font geladen und passen sich automatisch an das gewählte Theme an.
...
#### 🔧 **Technische Updates**
- **Datenbank Version 24:** Neue `dungeon_progress` Tabelle für Dungeon-Fortschritt
...
- **Komplett überarbeitete Übungsbibliothek:** Alle Übungen funktionieren jetzt mit Hanteln, Langhantel oder Körpergewicht
- **Entfernte Geräte-abhängige Übungen:** Keine Klimmzugstangen, Kettlebells oder spezielle Geräte mehr nötig
- **Neue Home-Gym Übungen:**
  - Pike Push-ups (Schultern, Arme, Rumpfstabilität) - 25 Mana, 35 Gold
  - Diamond Push-ups (intensiver Trizeps) - 28 Mana, 40 Gold
  - Leg Raises (untere Bauchmuskeln) - 26 Mana, 34 Gold
  - Reverse Flys (hintere Schultermuskulatur) - 17 Mana, 21 Gold
  - Single Leg Glute Bridge (Gesäß & hintere Oberschenkel) - 30 Mana, 38 Gold
  - Dumbbell Swings (Kraft & Ausdauer) - 23 Mana, 32 Gold
  - Shadowboxing (Koordination, Ausdauer & Kraft) - 30 Mana, 10 Gold
...
- **Harmonische Farbpalette:** Keine roten oder orange Farben mehr - nur noch harmonische Lila-, Grün-, Blau- und Cyan-Töne
- **Adaptive Breite:** Labels passen sich automatisch an die Textlänge an - keine abgeschnittenen Wörter mehr
- **Interaktive Tooltips:** Klicke auf dein Label für detaillierte Informationen

#### 🎨 **Verbesserte Animationen & UI**
- **Verstärkte Hintergrund-Animation:** Pulsierende Effekte um 8% stärker für mehr Dynamik
- **Kürzere Übungsnamen:** Prägnante Namen mit Details in den Beschreibungen
- **Optimierte Übersetzungen:** Konsistente Namensgebung in Deutsch und Englisch
- **Verbesserte Responsivität:** Alle Elemente funktionieren perfekt auf allen Bildschirmgrößen
...
- **Verbesserte Datenbank-Migration:** Nahtlose Updates ohne Datenverlust (DB Version 23)
- **Service Worker Optimierung:** Cache-Version v5 mit verbesserter Update-Strategie
...
- **Veröffentlichungsbereit:** Vollständige Kompatibilitätstests bestanden - keine Datenverluste bei Updates
...
### Version 2.0 - "Player Labels & Enhanced Training" (Vorherige Version)
