...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // --- NEUE FUNKTION FÜR SLIDER-STYLING ---
    ...
    function addSettingsListeners(elements) {
        ...
        elements.difficultySlider.addEventListener('input', (e) => { 
            ...
            updateDifficultySliderStyle(e.target); // Style live aktualisieren
        });
        ...
        return new Promise(resolve => {
            if (key === 'name') {
                ...
                tx.oncomplete = () => {
                    ...
                    if (key === 'theme') {
                        DQ_UI.applyTheme();
                        // Slider-Farbe nach Theme-Wechsel neu berechnen
    ...
    function updateSettingsUI() {
        ...
        updateDifficultySliderStyle(elements.difficultySlider); // Initiales Styling für den Slider
