document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        de: {
            ...
            free_training: "Freies Training", character_name: "Name",
            ...
            exercise_names: {
                ...
                lunges: "Ausfallschritte 🦵", sumo_squats: "Sumo Squats 🦵", glute_bridges: "Hüftheben 🍑",
        ...
        en: {
            ...
            free_training: "Free Training", character_name: "Name",
    ...
    const exerciseExplanations = {
        de: {
            ...
            glute_bridges: "Lege dich auf den Rücken, Knie gebeugt. Hebe die Hüfte so hoch wie möglich, spanne den Po an. Kurz halten und langsam ablassen.",
                    ...
                    if (cursor) {
                        ...
                        newQuests.forEach(questTemplate => {
                            ...
                            if(questTemplate.type !== 'check' && questTemplate.type !== 'link') {
                                targetValue = Math.ceil(questTemplate.baseValue + (questTemplate.baseValue * 0.4 * (userSettings.difficulty - 1)));
                            }
        ...
        store.count().onsuccess = (e) => {
            if (e.target.result === 0) {
                const defaultExercises = [ 
                    ...
                    { id: 7, nameKey: 'pinterest_workout', manaReward: 60, goldReward: 20 }
                ];
